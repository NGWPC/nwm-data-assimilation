...
import data_assimilation_engine.output_variables.NetCdfProductionManager as mgr

def download_netcdf_from_nomads(output_folder: str, output_cycle_type: str, re_download: bool = False):
    #Usage:
    # python netcdf_production_sample.py download-nwm-outputs sample_data
    utils.download_nwm_data_from_server(output_folder, output_cycle_type, re_download)
...
def overall_netcdf_workflow(ngen_netcdf_output_file: str, ngen_gpkg_file: str, output_folder: str,
    ...
    for mdata in netcdf_metadata_list:
        if mdata.output_cycle == output_cycle_type and mdata.domain == output_cycle_domain:
            ...
            #if mdata.category.startswith('land'):
            processor.nwm_output_cycle = mdata.output_cycle
...
def main() -> None:
    ...
    args_list_3S = ["/home/siva.selvanathan/ngwpc/nwm-data-assimilation/sample_data/outputs_0818",
                 "/home/siva.selvanathan/ngwpc/nwm-data-assimilation/sample_data/outputs_0730/ngen_outputs/vpu_scale/catchment_output_ana_03S.nc",
                 "/home/siva.selvanathan/ngwpc/nwm-data-assimilation/sample_data/outputs_0730/ngen_outputs/vpu_scale/vpu_03S.gpkg",
                  "/home/siva.selvanathan/ngwpc/nwm-data-assimilation/sample_data/outputs_0730/ngen_outputs/vpu_scale/troute_output_ana_03S.nc",
                  "/home/siva.selvanathan/ngwpc/nwm-data-assimilation/sample_data/outputs_0730/ngen_outputs/vpu_scale/troute_lakeout_ana_03S.nc",
                  "/home/siva.selvanathan/ngwpc/nwm-data-assimilation/sample_data/outputs_0818/configs/metadata_config.json",
                  None,
                  "1",
                  "analysis_assim",
                  "conus",
    ...
    args_list_3N = ["/home/siva.selvanathan/ngwpc/nwm-data-assimilation/sample_data/outputs_0818",
                "/home/siva.selvanathan/ngwpc/nwm-data-assimilation/sample_data/outputs_0730/ngen_outputs/vpu_scale/catchment_output_ana_03N.nc",
                "/home/siva.selvanathan/ngwpc/nwm-data-assimilation/sample_data/outputs_0730/ngen_outputs/vpu_scale/vpu_03N.gpkg",
                "/home/siva.selvanathan/ngwpc/nwm-data-assimilation/sample_data/outputs_0730/ngen_outputs/vpu_scale/troute_output_ana_03N.nc",
                "/home/siva.selvanathan/ngwpc/nwm-data-assimilation/sample_data/outputs_0730/ngen_outputs/vpu_scale/troute_lakeout_ana_03N.nc",
                "/home/siva.selvanathan/ngwpc/nwm-data-assimilation/sample_data/outputs_0818/configs/metadata_config.json",
                None,
                "1",
                "analysis_assim",
    ...
    args_list_mosaic = [
                "/home/siva.selvanathan/ngwpc/nwm-data-assimilation/sample_data/outputs_0818/nwm_output",
                 "/home/siva.selvanathan/ngwpc/nwm-data-assimilation/sample_data/outputs_0818/nwm_mosaics",
                 "/home/siva.selvanathan/ngwpc/nwm-data-assimilation/sample_data/outputs_0818/configs/metadata_config.json",
                 "1",
                 "analysis_assim",
                 "conus",
    ...
    # mgr.netcdf_production_workflow(args_list_3N)
    # mgr.netcdf_production_workflow(args_list_3S)
    mgr.netcdf_production_workflow(args_list_mosaic)
    return
    ...
    parser_nwm_download.add_argument("output_cycle_type")
    ...
    if args.command == "download-nwm-outputs":
        download_netcdf_from_nomads(args.output_folder_path, args.output_cycle_type)
