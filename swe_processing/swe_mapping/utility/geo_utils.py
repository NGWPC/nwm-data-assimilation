"""Utility functions for geographic data handling in SWE mapping."""
...
class GeoUtils:
    """Utility functions for geographic data handling."""
    ...
    @staticmethod
    def get_basin_geometry(basin_gdf: gpd.GeoDataFrame) -> tuple:
