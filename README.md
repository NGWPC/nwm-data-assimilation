...
### Input Parameters for NetCDF production workflow
  ...
  - `netcdf_file`: The NetCDF file produced by NGEN that contains computational outputs of the simulation run. Absolute or relative paths allowed.
  - `gpkg_file`: The geopackage file input to NGEN that defines the extent of the NWM NetCDF output files. Absolute or relative paths allowed.
  - `troute_output_netcdf`: The NetCDF file produced by T-Route that contains computational outputs of the simulation run. Absolute or relative paths allowed.
  - `troute_lakeout_netcdf`: The waterbody NetCDF file produced by T-Route that contains computational outputs of the simulation run. Absolute or relative paths allowed.
  - `config_json`: The name of the metadata config file to be created or available from a previous run. Absolute or relative paths allowed.
  ...
  - `output_templates_folder`: The directory where the post-processing templates are created or available from a previous run. Absolute or relative paths allowed.
